    ...
    <div className="mt-20">
      <footer className="footer footer-center bg-[#023E8A] p-4 flex flex-col text-white">
        <div>
          ...
          <p>
            Send your parcel to its destination safely and efficiently with us.
          </p>
        </div>
        <nav className="grid grid-flow-col gap-4">
          ...
          <a
            target="_blank"
            href="https://portfolio-of-shuvo.web.app/"
            className="link link-hover"
          >
            Contact
          </a>
          <a href="mailto:saheenshuvo182@gmail.com" className="link link-hover">
            Report
          </a>
          <a
